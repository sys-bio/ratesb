...
class ProcessSBML {
    constructor( modelStr, pyodide, libsbml, checks, customClassificationList) {
        ...
        for (i = 0; i < this.model.getNumReactions(); i++) {
            this.reactions.push(new Reaction(this.model, this.model.getReaction(i), this.functionDefinitions, pyodide, this, checks, customClassificationList));
        }
    }
